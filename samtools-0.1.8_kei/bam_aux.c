...
#ifdef _TARGET_KEI
	else if (type == 's') return (int32_t)getint16(s);
	else if (type == 'S') return (int32_t)getuint16(s);
	else if (type == 'i' || type == 'I') return getint32(s);
#else
